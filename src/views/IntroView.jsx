...
export default function IntroView({ dark, onNavigate }) {
  return (
    <>
      ...
      <main>
          ...
          <div className="container">
            ...
            <div className="card-grid">
              <button className="card card-link" onClick={() => onNavigate('cluster')}>
                ...
                <h3>클러스터 결과</h3>
                <p>타겟 종목 39개를 임베딩 → t-SNE · UMAP 으로 군집화한 결과예요.</p>
              </button>
              <button className="card card-link" onClick={() => onNavigate('api')}>
                <span className="emoji">🔌</span>
                <h3>API 테스트</h3>
                <p>Google News · Reddit · EDGAR 수집기가 모아온 실제 데이터 스냅샷이에요.</p>
              </button>
              <button className="card card-link" onClick={() => onNavigate('screener')}>
                <span className="emoji">🎯</span>
                <h3>Screener 필터</h3>
                <p>나스닥 전 종목 스냅샷에 팀 타겟 필터를 브라우저에서 직접 적용해봐요.</p>
              </button>
            </div>
          </div>
        </section>
            ...
            <div className="chart-grid">
              <div className="chart-card">
                ...
                <div className="chart-body">
                  <TradingViewChart symbol="OANDA:NAS100USD" dark={dark} />
                </div>
              </div>
              <div className="chart-card">
                <h3>🌟 S&amp;P 500</h3>
                <div className="chart-body">
                  <TradingViewChart symbol="OANDA:SPX500USD" dark={dark} />
                </div>
              </div>
            </div>
        ...
        <section id="roadmap" className="alt-bg">
          <div className="container">
